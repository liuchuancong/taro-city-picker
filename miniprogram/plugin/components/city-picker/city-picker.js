...
(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([["plugin/components/city-picker/city-picker"],{

/***/ "./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/plugin/components/city-picker/city-picker.tsx?taro&type=script&parse=COMPONENT&":
/*!******************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./src/plugin/components/city-picker/city-picker.tsx?taro&type=script&parse=COMPONENT& ***!
  \******************************************************************************************************************************************************************************/
...
__webpack_require__(/*! ./city-picker.scss */ "./src/plugin/components/city-picker/city-picker.scss");

var _city = __webpack_require__(/*! ./city */ "./src/plugin/components/city-picker/city.js");
...
var CityPicker = (_temp2 = _class = function (_BaseComponent) {
  _inherits(CityPicker, _BaseComponent);
  ...
  function CityPicker() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CityPicker.__proto__ || Object.getPrototypeOf(CityPicker)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["openState", "anonymousState__temp", "value", "provinces", "cities", "areas", "selecedLocation", "single", "color", "textColor", "indicatorStyle", "indicatorClass", "height", "provice", "city", "area"], _this.onChange = function (e) {
      _this.whenLocationUpdate(_this.getUpdataCodeArr(e.detail.value));
  ...
  _createClass(CityPicker, [{
    ...
    value: function _constructor(props) {
      _get(CityPicker.prototype.__proto__ || Object.getPrototypeOf(CityPicker.prototype), "_constructor", this).call(this, props);
    ...
    key: "getLocationInfomation",
    value: function getLocationInfomation(pickCodeArr) {
      var selecedArr = pickCodeArr;
      var provincesArr = [];
      var citiesArr = [];
      var areasArr = [];
      for (var province in _city.provincesData) {
        if (_city.provincesData.hasOwnProperty(province)) {
          var provinceData = _city.provincesData[province];
          provincesArr.push(provinceData);
          if (province == selecedArr[0]) {
            //选择的城市
            for (var cities in _city.citiesData[selecedArr[0]]) {
              //得到市的列表
              citiesArr.push(_city.citiesData[selecedArr[0]][cities].name);
              if (cities == selecedArr[1]) {
                for (var area in _city.citiesData[cities]) {
                  //得到全区
                  var areaData = _city.citiesData[cities][area];
    ...
    value: function initData() {
      var codeArr = this.props.selecedLocation;

      var _getIndexFromCode = this.getIndexFromCode(codeArr),
          selectedIndexArr = _getIndexFromCode.selectedIndexArr,
          selectedLocationArr = _getIndexFromCode.selectedLocationArr;

      var _getLocationInfomatio = this.getLocationInfomation(codeArr),
          provincesArr = _getLocationInfomatio.provincesArr,
          citiesArr = _getLocationInfomatio.citiesArr,
          areasArr = _getLocationInfomatio.areasArr;
    ...
    key: "getIndexFromCode",
    value: function getIndexFromCode() {
      var pickIndexArr = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

      var selecedArr = pickIndexArr || this.props.selecedLocation || [];
      var selectedIndexArr = [];
      var selectedLocationArr = [];
      //得到省的索引和名称
      var nationWide = Object.keys(_city.provincesData);
      this.pushIndex(nationWide, selecedArr[0], selectedIndexArr);
      var provinces = Object.values(_city.provincesData);
      selectedLocationArr.push(provinces[selectedIndexArr[0]]);
      // 得到城市的索引和名称
      if (selecedArr[1]) {
        var cityWide = Object.keys(_city.citiesData[selecedArr[0]]);
        this.pushIndex(cityWide, selecedArr[1], selectedIndexArr);
        var cities = Object.values(_city.citiesData[selecedArr[0]]);
        selectedLocationArr.push(cities[selectedIndexArr[1]].name);
      }
      // 得到区的索引和名称
      if (selecedArr[2]) {
        var wholeArea = Object.keys(_city.citiesData[selecedArr[1]]);
        this.pushIndex(wholeArea, selecedArr[2], selectedIndexArr);
        var areas = Object.values(_city.citiesData[selecedArr[1]]);
        selectedLocationArr.push(areas[selectedIndexArr[2]].name);
      }
      return { selectedIndexArr: selectedIndexArr, selectedLocationArr: selectedLocationArr };
    }
  }, {
    key: "pushIndex",
    value: function pushIndex(arr, key, selecedArr) {
      if (arr.indexOf(key) != -1) {
        selecedArr.push(arr.indexOf(key));
      }
    }
  }, {
    key: "getCodeFromIndex",
    value: function getCodeFromIndex(indexArr) {
      var selecedArr = indexArr;
      var selectedCodeArr = [];
      var nationWide = Object.keys(_city.provincesData);
      selectedCodeArr.push(nationWide[selecedArr[0]]);
      if (_city.citiesData.hasOwnProperty(nationWide[selecedArr[0]])) {
        var cityWide = Object.keys(_city.citiesData[nationWide[selecedArr[0]]]);
        selectedCodeArr.push(cityWide[selecedArr[1]]);
        if (_city.citiesData.hasOwnProperty(cityWide[selecedArr[1]])) {
          var wholeArea = Object.keys(_city.citiesData[cityWide[selecedArr[1]]]);
    ...
    key: "whenLocationUpdate",
    value: function whenLocationUpdate(arr) {
      var _this2 = this;

      var codeArr = this.getCodeFromIndex(arr);
      var pickArr = this.getIndexFromCode(codeArr);

      var _getLocationInfomatio2 = this.getLocationInfomation(codeArr),
          provincesArr = _getLocationInfomatio2.provincesArr,
          citiesArr = _getLocationInfomatio2.citiesArr,
          areasArr = _getLocationInfomatio2.areasArr;

      this.setState({
        provinces: provincesArr,
        provice: pickArr.selectedLocationArr[0],
        cities: citiesArr,
        city: pickArr.selectedLocationArr[1] ? pickArr.selectedLocationArr[1] : "",
        areas: areasArr,
        area: pickArr.selectedLocationArr[2] ? pickArr.selectedLocationArr[2] : ""
      }, function () {
        _this2.setState({
          value: arr
        });
    ...
    key: "onClosePciker",
    value: function onClosePciker() {
      this.props.onPickerClose();
    }
  }, {
    key: "getUpdataCodeArr",
    value: function getUpdataCodeArr(tempArr) {
      var upDataArr = [];
      var currentIndexArr = this.state.value;
      if (currentIndexArr[0] != tempArr[0]) {
        upDataArr.push(tempArr[0], 0, 0);
      } else if (currentIndexArr[0] == tempArr[0] && currentIndexArr[1] != tempArr[1]) {
        upDataArr.push(tempArr[0], tempArr[1], 0);
      } else if (currentIndexArr[0] == tempArr[0] && currentIndexArr[1] == tempArr[1] && currentIndexArr[2] != tempArr[2]) {
        upDataArr.push(tempArr[0], tempArr[1], tempArr[2]);
      }
      return upDataArr;
    }
  }, {
    key: "onSelectedPciker",
    value: function onSelectedPciker() {
      var params = {};
      var _state = this.state,
          provice = _state.provice,
          city = _state.city,
          area = _state.area;
    ...
    key: "_createGetFooterViewData",
    value: function _createGetFooterViewData(_$uid) {
      var _this3 = this;
    ...
    value: function _createData() {
      ...
      var openState = this.__props.openState;


      var anonymousState__temp = this._createGetFooterViewData(__prefix + "bzzzzzzzzz")();
  ...
  return CityPicker;
}(_taroWeapp.Component), _class.$$events = ["onSelectedPciker", "onClosePciker", "onClosePciker", "onChange"], _class.$$componentPath = "plugin/components/city-picker/city-picker", _temp2);


CityPicker.defaultProps = _defaultProps;
exports.default = CityPicker;

Component(__webpack_require__(/*! @tarojs/taro-weapp */ "./node_modules/@tarojs/taro-weapp/index.js").default.createComponent(CityPicker));

/***/ }),

/***/ "./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=E:\\projects\\city_pickers\\src!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/plugin/components/city-picker/city-picker.tsx?taro&type=template&parse=COMPONENT&":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=E:/projects/city_pickers/src!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./src/plugin/components/city-picker/city-picker.tsx?taro&type=template&parse=COMPONENT& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "plugin/components/city-picker/city-picker.wxml";

/***/ }),

/***/ "./src/plugin/components/city-picker/city-picker.scss":
/*!************************************************************!*\
  !*** ./src/plugin/components/city-picker/city-picker.scss ***!
  \************************************************************/
/*! no static exports found */
...
/***/ "./src/plugin/components/city-picker/city-picker.tsx":
/*!***********************************************************!*\
  !*** ./src/plugin/components/city-picker/city-picker.tsx ***!
  \***********************************************************/
/*! no static exports found */
...
/* harmony import */ var _city_picker_tsx_taro_type_template_parse_COMPONENT___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./city-picker.tsx?taro&type=template&parse=COMPONENT& */ "./src/plugin/components/city-picker/city-picker.tsx?taro&type=template&parse=COMPONENT&");
/* harmony import */ var _city_picker_tsx_taro_type_script_parse_COMPONENT___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./city-picker.tsx?taro&type=script&parse=COMPONENT& */ "./src/plugin/components/city-picker/city-picker.tsx?taro&type=script&parse=COMPONENT&");
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _city_picker_tsx_taro_type_script_parse_COMPONENT___WEBPACK_IMPORTED_MODULE_1__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _city_picker_tsx_taro_type_script_parse_COMPONENT___WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
/***/ "./src/plugin/components/city-picker/city-picker.tsx?taro&type=script&parse=COMPONENT&":
/*!*********************************************************************************************!*\
  !*** ./src/plugin/components/city-picker/city-picker.tsx?taro&type=script&parse=COMPONENT& ***!
  \*********************************************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_tarojs_mini_runner_dist_loaders_wxTransformerLoader_js_ref_6_0_city_picker_tsx_taro_type_script_parse_COMPONENT___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./city-picker.tsx?taro&type=script&parse=COMPONENT& */ "./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/plugin/components/city-picker/city-picker.tsx?taro&type=script&parse=COMPONENT&");
/* harmony import */ var _node_modules_tarojs_mini_runner_dist_loaders_wxTransformerLoader_js_ref_6_0_city_picker_tsx_taro_type_script_parse_COMPONENT___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_tarojs_mini_runner_dist_loaders_wxTransformerLoader_js_ref_6_0_city_picker_tsx_taro_type_script_parse_COMPONENT___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_tarojs_mini_runner_dist_loaders_wxTransformerLoader_js_ref_6_0_city_picker_tsx_taro_type_script_parse_COMPONENT___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_tarojs_mini_runner_dist_loaders_wxTransformerLoader_js_ref_6_0_city_picker_tsx_taro_type_script_parse_COMPONENT___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_tarojs_mini_runner_dist_loaders_wxTransformerLoader_js_ref_6_0_city_picker_tsx_taro_type_script_parse_COMPONENT___WEBPACK_IMPORTED_MODULE_0___default.a); 

/***/ }),

/***/ "./src/plugin/components/city-picker/city-picker.tsx?taro&type=template&parse=COMPONENT&":
/*!***********************************************************************************************!*\
  !*** ./src/plugin/components/city-picker/city-picker.tsx?taro&type=template&parse=COMPONENT& ***!
  \***********************************************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _file_loader_name_path_name_wxml_context_E_projects_city_pickers_src_node_modules_tarojs_mini_runner_dist_loaders_miniTemplateLoader_js_node_modules_tarojs_mini_runner_dist_loaders_wxTransformerLoader_js_ref_6_0_city_picker_tsx_taro_type_template_parse_COMPONENT___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!file-loader?name=[path][name].wxml&context=E:/projects/city_pickers/src!../../../../node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!../../../../node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./city-picker.tsx?taro&type=template&parse=COMPONENT& */ "./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=E:\\projects\\city_pickers\\src!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/plugin/components/city-picker/city-picker.tsx?taro&type=template&parse=COMPONENT&");
/* harmony import */ var _file_loader_name_path_name_wxml_context_E_projects_city_pickers_src_node_modules_tarojs_mini_runner_dist_loaders_miniTemplateLoader_js_node_modules_tarojs_mini_runner_dist_loaders_wxTransformerLoader_js_ref_6_0_city_picker_tsx_taro_type_template_parse_COMPONENT___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_file_loader_name_path_name_wxml_context_E_projects_city_pickers_src_node_modules_tarojs_mini_runner_dist_loaders_miniTemplateLoader_js_node_modules_tarojs_mini_runner_dist_loaders_wxTransformerLoader_js_ref_6_0_city_picker_tsx_taro_type_template_parse_COMPONENT___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _file_loader_name_path_name_wxml_context_E_projects_city_pickers_src_node_modules_tarojs_mini_runner_dist_loaders_miniTemplateLoader_js_node_modules_tarojs_mini_runner_dist_loaders_wxTransformerLoader_js_ref_6_0_city_picker_tsx_taro_type_template_parse_COMPONENT___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _file_loader_name_path_name_wxml_context_E_projects_city_pickers_src_node_modules_tarojs_mini_runner_dist_loaders_miniTemplateLoader_js_node_modules_tarojs_mini_runner_dist_loaders_wxTransformerLoader_js_ref_6_0_city_picker_tsx_taro_type_template_parse_COMPONENT___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));


/***/ }),

/***/ "./src/plugin/components/city-picker/city.js":
/*!***************************************************!*\
  !*** ./src/plugin/components/city-picker/city.js ***!
  \***************************************************/
/*! no static exports found */
...
var provincesData = exports.provincesData = {
  "110000": "北京市",
  "120000": "天津市",
  "130000": "河北省",
  "140000": "山西省",
...
var citiesData = exports.citiesData = {
  "110000": {
...
},[["./src/plugin/components/city-picker/city-picker.tsx","plugin/runtime","plugin/vendors"]]]);;